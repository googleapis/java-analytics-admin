...
public interface ListAndroidAppDataStreamsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.ListAndroidAppDataStreamsRequest)
