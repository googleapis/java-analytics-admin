 ...
 */
public final class ListAndroidAppDataStreamsResponse extends
...
private static final long serialVersionUID = 0L;
  ...
  private ListAndroidAppDataStreamsResponse(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              androidAppDataStreams_ = new java.util.ArrayList<com.google.analytics.admin.v1alpha.AndroidAppDataStream>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.analytics.admin.v1alpha.AnalyticsAdminProto.internal_static_google_analytics_admin_v1alpha_ListAndroidAppDataStreamsResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.analytics.admin.v1alpha.AnalyticsAdminProto.internal_static_google_analytics_admin_v1alpha_ListAndroidAppDataStreamsResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse.class, com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse.Builder.class);
  }

  public static final int ANDROID_APP_DATA_STREAMS_FIELD_NUMBER = 1;
  private java.util.List<com.google.analytics.admin.v1alpha.AndroidAppDataStream> androidAppDataStreams_;
  /**
   * <pre>
   * Results that matched the filter criteria and were accessible to the caller.
   * </pre>
   *
   * <code>repeated .google.analytics.admin.v1alpha.AndroidAppDataStream android_app_data_streams = 1;</code>
   */
  @java.lang.Override
  public java.util.List<com.google.analytics.admin.v1alpha.AndroidAppDataStream> getAndroidAppDataStreamsList() {
   ...
   */
  @java.lang.Override
  public com.google.analytics.admin.v1alpha.AndroidAppDataStream getAndroidAppDataStreams(int index) {
   ...
   */
  @java.lang.Override
  public com.google.analytics.admin.v1alpha.AndroidAppDataStreamOrBuilder getAndroidAppDataStreamsOrBuilder(
      int index) {
    return androidAppDataStreams_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < androidAppDataStreams_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, androidAppDataStreams_.get(i));
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(nextPageToken_)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse other = (com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse) obj;

    if (!getAndroidAppDataStreamsList()
        .equals(other.getAndroidAppDataStreamsList())) return false;
    if (!getNextPageToken()
  ...
  public static com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse parseFrom(
  ...
  public static com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse getDefaultInstanceForType() {
      return com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse.getDefaultInstance();
    }
    ...
    public com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse buildPartial() {
      com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse result = new com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse) {
        return mergeFrom((com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse other) {
      if (other == com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse.getDefaultInstance()) return this;
      if (androidAppDataStreamsBuilder_ == null) {
          ...
          if (androidAppDataStreamsBuilder_.isEmpty()) {
            ...
            androidAppDataStreamsBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getAndroidAppDataStreamsFieldBuilder() : null;
          } else {
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse) e.getUnfinishedMessage();
    ...
    private void ensureAndroidAppDataStreamsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        androidAppDataStreams_ = new java.util.ArrayList<com.google.analytics.admin.v1alpha.AndroidAppDataStream>(androidAppDataStreams_);
     ...
     */
    public Builder setAndroidAppDataStreams(
        int index, com.google.analytics.admin.v1alpha.AndroidAppDataStream.Builder builderForValue) {
      if (androidAppDataStreamsBuilder_ == null) {
        ensureAndroidAppDataStreamsIsMutable();
     ...
     * <code>repeated .google.analytics.admin.v1alpha.AndroidAppDataStream android_app_data_streams = 1;</code>
     */
    public Builder addAndroidAppDataStreams(com.google.analytics.admin.v1alpha.AndroidAppDataStream value) {
      if (androidAppDataStreamsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllAndroidAppDataStreams(
        java.lang.Iterable<? extends com.google.analytics.admin.v1alpha.AndroidAppDataStream> values) {
      if (androidAppDataStreamsBuilder_ == null) {
        ensureAndroidAppDataStreamsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, androidAppDataStreams_);
        onChanged();
      } else {
     ...
     * <code>repeated .google.analytics.admin.v1alpha.AndroidAppDataStream android_app_data_streams = 1;</code>
     */
    public com.google.analytics.admin.v1alpha.AndroidAppDataStream.Builder getAndroidAppDataStreamsBuilder(
        int index) {
    ...
    public com.google.analytics.admin.v1alpha.AndroidAppDataStreamOrBuilder getAndroidAppDataStreamsOrBuilder(
        int index) {
      if (androidAppDataStreamsBuilder_ == null) {
        return androidAppDataStreams_.get(index);  } else {
     ...
     * <code>repeated .google.analytics.admin.v1alpha.AndroidAppDataStream android_app_data_streams = 1;</code>
     */
    public com.google.analytics.admin.v1alpha.AndroidAppDataStream.Builder addAndroidAppDataStreamsBuilder() {
      return getAndroidAppDataStreamsFieldBuilder().addBuilder(
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        ...
        getAndroidAppDataStreamsFieldBuilder() {
      if (androidAppDataStreamsBuilder_ == null) {
        androidAppDataStreamsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.google.analytics.admin.v1alpha.AndroidAppDataStream, com.google.analytics.admin.v1alpha.AndroidAppDataStream.Builder, com.google.analytics.admin.v1alpha.AndroidAppDataStreamOrBuilder>(
  ...
  private static final com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse();
  }

  public static com.google.analytics.admin.v1alpha.ListAndroidAppDataStreamsResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<ListAndroidAppDataStreamsResponse>
      PARSER = new com.google.protobuf.AbstractParser<ListAndroidAppDataStreamsResponse>() {
    @java.lang.Override
